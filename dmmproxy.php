...
/* config settings */
$base = "http://www.dmm.com";  //set this to the url you want to scrape
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	curl_setopt ($curlSession, CURLOPT_POSTFIELDS, file_get_contents("php://input"));
}
...
curl_setopt($curlSession, CURLOPT_HTTPHEADER, getallheaders());
